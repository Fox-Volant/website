                                ...
                                <Row>
                                    ...
                                    >
                                        ...
                                        <p>
                                            ...
                                            DJI camera drones, we've still on a
                            ...
                            <TextFrame>
                                <Row>
                                    ...
                                    >
                                        <h2>What do we do?</h2>
                                        <p>
                                            We firmly believe that drones and
                                            other Unmanned Aerial Vehicles
                                            (UAVs) are revolutionising many
                                            well-established industries, as well
                                            as helping create new ones as yet
                                            unenvisioned. Our main focus is{" "}
                                            <strong>photogrammetry</strong>,
                                            which as a concept has been around
                                            since the early days of photography,
                                            but really took off with the
                                            invention of the aeroplane by the
                                            Wright brothers.
                                        </p>
                                        <p>
                                            By capturing a large number of
                                            high-resolution aerial photographs
                                            from the air, these can then be
                                            stitched together to create a 2D
                                            orthomosaic or 3D model that has
                                            been geometrically corrected. These
                                            can provide an up-to-date and more
                                            detailed alternative to publicly
                                            available satellite imagery such as
                                            on Google or Bing maps.
                                        </p>
                                        <p>
                                            Whether you are viewing fields,
                                            woodland, sites of historical
                                            interest or a development site,
                                            these capture an alternative view of
                                            your site. Geometric correction
                                            takes into account the curvature of
                                            the earth to provide more accurate
                                            measurements. Periodically
                                            rescanning an area will also provide
                                            you with a guide to how your site
                                            has changed over time, be it weeks,
                                            months or years.
                                        </p>
                                    </Col>
                                </Row>
                            ...
                            <TextFrame>
                                <Row>
                                    ...
                                    >
                                        ...
                                        <p>
                                            As well as getting to use some
                                            ridiculously cool tech, there is a
                                            fundamental shift happening all
                                            around us which must be
                                            acknowledged. This hasn't been
                                            brought about by one thing, rather a
                                            mix of the global pandemic, changing
                                            working practices, climate change,
                                            energy crisis and the cost of living
                                            crisis.
                                        </p>
                                        <p>
                                            When asking ourselves What can we
                                            do?, we realised that by gathering
                                            and presenting data in an efficient
                                            manner we allow businesses and
                                            individuals to be more aware of
                                            their surroundings and the impact
                                            these shifts are having on the world
                                            around us. Having access to this
                                            data helps to make the right
